...
var obj = { a: 123 }; // 객체를 표현할 때는 괄호로 묶지 않아도 잘 작동한다.
var 이름; //말 그대로 아무거나 다 들어가도 됨 하지만 any는 타입실드 해제라서 일반 js와 다를게 없다.
var 이름2; // any보다 조금 더 안전한 타입 설정 방법이다.any랑 다르게 타입실드를 해제하지 않는다.
var age2;
